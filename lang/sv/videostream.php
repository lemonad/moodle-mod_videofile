...
/**
 * Swedish strings for videostream
 *
...
$string['modulenameplural'] = 'videostreamr';
...
$string['videostream:addinstance'] = 'Lägg till en ny videofil';
$string['videostream:view'] = 'Visa videofil';

$string['pluginadministration'] = 'Administration för videofil';
$string['pluginname'] = 'Videofil';

$string['videostream_defaults_heading'] = 'Standardvärden för videofil-inställningar';
$string['videostream_defaults_text'] = 'De värden du sätter här blir standardvärden som används i inställningsformuläret när du skapar en ny videofil.';
