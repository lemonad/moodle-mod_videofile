...
class mod_videofile_renderer extends plugin_renderer_base {
    ...
    public function video_header($videofile) {
        ...
        $this->page->requires->css('/mod/videofile/video-js-4.2.1/video-js.min.css');
        $this->page->requires->js('/mod/videofile/video-js-4.2.1/video.js', true);

        // Set the videojs flash fallback url.
        $swfurl = new moodle_url('/mod/videofile/video-js-4.2.1/video-js.swf');
